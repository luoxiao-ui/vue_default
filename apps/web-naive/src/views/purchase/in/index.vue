...
import { SearchIcon, AddIcon, ExportIcon } from '@vben/icons';
...
import {purchaseInDateType, purchaseInStatus} from "#/views/purchase/in/constant";
...
const gridOptions: VxeTableGridOptions<any> = {
  ...
  columns: [
    ...
    { title: '含税金额', field: 'money', width: 120 },
    { title: '入库金额', field: 'in_money', width: 120 },
    { title: '供应商', field: 'supplier_name', width: 140 },
    { title: '入库仓库', field: 'storehouse_name', width: 140 },
    { title: '入库人', field: 'audit_by', width: 120 },
    { title: '入库日期', field: 'audit_time', width: 140 },
    { title: '采购收货单', field: 'receive_order_fid', width: 140 },
  ],
  data: data.value,
  pagerConfig: {
