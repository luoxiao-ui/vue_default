...
import { SearchIcon, AddIcon, ExportIcon, DeleteIcon } from '@vben/icons';
...
import {purchaseReturnDateType, purchaseReturnStatus} from "#/views/purchase/return/constant";
...
const formOptions: VbenFormProps = {
  ...
  schema: [
    ...
    },
    {
      component: 'Select',
      componentProps: {
        options: purchaseReturnDateType,
      },
      fieldName: 'time_type',
...
const gridOptions: VxeTableGridOptions<any> = {
  ...
  columns: [
    ...
    { title: '退货金额', field: 'money', width: 120 },
    { title: '供应商', field: 'supplier_name', width: 140 },
    { title: '退货仓库', field: 'storehouse_name', width: 140 },
    { title: '所属客户', field: 'client_name', width: 120 },
    { title: '退货人', field: 'create_by', width: 140 },
    { title: '退货日期', field: 'create_time', width: 140 },
    { title: '采购入库单', field: 'purchase_orders', width: 140 },
  ],
  data: data.value,
  pagerConfig: {
