...
const gridOptions: VxeTableGridOptions<any> = {
  ...
  columns: [
    ...
    {title: '到期日期', field: 'expire_date', width: 100},
    {title: '单位', field: 'unit', width: 100},
    {title: '销售数量', field: 'quantity', width: 100},
    {title: '单价', field: 'price', width: 100},
    {title: '销售金额', field: 'money', width: 100},
