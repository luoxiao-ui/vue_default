...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/vite-config": "/Users/zhaocheng/WebstormProjects/vue_default/internal/vite-config"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/Users/zhaocheng/WebstormProjects/vue_default/internal/vite-config/src/index.js")} */
const _module = await jiti.import("/Users/zhaocheng/WebstormProjects/vue_default/internal/vite-config/src/index.ts");
